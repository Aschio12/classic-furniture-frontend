...
{/* Render Landing Page Regardless of Auth Status */}
          ...
          >
              ...
              >
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  <button 
                    ...
                    className="relative overflow-hidden rounded-full border border-white/20 px-4 py-2 text-[11px] tracking-[0.18em] text-white/80 transition-all duration-300 hover:border-[#D4AF37]/40 hover:text-white md:px-6"
                  >
                    LOGIN
                  </button>
                  ...
                  <Dialog open={authModalOpen} onOpenChange={setAuthModalOpen}>
                    <DialogContent className="w-full border-0 bg-transparent p-0 shadow-none sm:max-w-md">
                      ...
                      >
                        ...
                        <div className="glass-oily backdrop-blur-[12px] saturate-[1.8] oil-slick-animated relative overflow-hidden rounded-2xl p-8 shadow-[0_30px_80px_rgba(0,0,0,0.12),0_0_0_1px_rgba(255,255,255,0.2)] min-h-[460px]">
                          <AnimatePresence mode="wait">
                            <motion.div
                              key={authMode}
            ...
            <section className="group relative min-h-screen w-full overflow-hidden cursor-default bg-[#0A0B0F]">
              ...
              >
                ...
                <motion.p
                  ...
                  className="mt-5 max-w-2xl text-base leading-relaxed text-white/90 drop-shadow-[0_2px_10px_rgba(0,0,0,0.25)] md:text-lg"
                >
            ...
            <section id="featured" className="relative mx-auto w-[94%] max-w-7xl py-16 md:py-32">
              {/* Section header */}
              <motion.div
            ...
            <section id="why-us" className="relative mx-auto w-[94%] max-w-7xl py-16 md:py-28">
            ...
            {/* ═══════════════ ABOUT / CTA BANNER ═══════════════ */}
            <section className="relative mx-auto w-[94%] max-w-7xl pb-16 pt-6 md:pb-32 md:pt-8">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7 }}
